...
static int myheight(SFONT* UNUSED(s))
{
    return 8;
}
static int myascent(SFONT* UNUSED(s))
{
    return 6;
}
static int mydescent(SFONT* UNUSED(s))
{
    return 2;
}
static int myminchar(SFONT* UNUSED(s))
{
    return 32;
}
static int mymaxchar(SFONT* UNUSED(s))
{
    return 126;
}
...
static SFONT myfont3 = {0,          nodestroy, myheight,  myascent,
                        mydescent,  myminchar, mymaxchar, myhasglyph,
                        mygetglyph, 0,         NULL};

SFONT* SF_font3 = &myfont3;

static int myheight2(SFONT* UNUSED(s))
{
    return 16;
}
static int myascent2(SFONT* UNUSED(s))
{
    return 14;
}
static int mydescent2(SFONT* UNUSED(s))
{
    return 2;
}
...
static SFONT myfont3dbl = {0,           nodestroy, myheight2, myascent2,
                           mydescent2,  myminchar, mymaxchar, myhasglyph,
                           mygetglyph2, 0,         NULL};
