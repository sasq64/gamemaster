...
const char* sf_msgstring(int id)
{
    ...
    case IDS_BLORB_GLULX:
        p = "unsupported Glulx code\n\nYou have attempted to load a Blorb file "
            "containing a Glulx game.\n"
            "For this game you need a Glulx interpreter instead.";
        break;
    case IDS_BLORB_NOEXEC:
        p = "no Z code\n\nYou have attempted to load a Blorb file that does "
            "not contain any\n"
            "recognized game data. It may be a Blorb file containing just "
            "graphics or\n"
    ...
    case IDS_FAIL_MODPLUG:
        ...
        break;
    case IDS_ABOUT_INFO:
        p = "{\\rtf1\\ansi{\\b Windows Frotz 1.10, written by David "
            "Kinder.\\line Another fine product of the Frobozz Magic Z-code "
            "Interpreter Company.}{\\line\\super{ }\\par}Windows Frotz is "
            "released under the terms of the GNU General Public License. See "
            "the file COPYING that is included with this program for "
            "details.{\\line\\super{ }\\par}Windows Frotz copyright David "
            "Kinder 2002-2006.\\line Frotz copyright Stefan Jokisch "
            "1995-1997.{\\line\\super{ }\\par}Frotz was written by Stefan "
            "Jokisch, with additions by Jim Dunleavy and David Griffith. "
            "Windows Frotz uses jpeglib by the Independent JPEG Group; libpng "
            "by Guy Eric Schalnat, Andreas Dilger, Glenn Randers-Pehrson, and "
            "others; zlib by Jean-loup Gailly and Mark Adler; ModPlug by "
            "Olivier Lapicque; and libogg and libvorbis by the Xiph.org "
            "Foundation.}";
        break;
    case IDS_SAVE_TITLE:
